...
use Hacco\DeeeBundle\Entity\Devis;
use Hacco\DeeeBundle\Form\DevisType;
...
class DevisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HaccoDeeeBundle:Devis')->findAll();
     ...
     * @Method("POST")
     * @Template("HaccoDeeeBundle:Devis:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HaccoDeeeBundle:Devis')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HaccoDeeeBundle:Devis:edit.html.twig")
     */
